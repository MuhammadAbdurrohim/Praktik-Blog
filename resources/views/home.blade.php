...
<head>
  ...
  <title>Home Page | Rohim Blog</title>
      ...
      <nav class="flex items-center justify-between p-6 lg:px-8" aria-label="Global">
        <div class="flex lg:flex-1">
          <a href="#" class="-m-1.5 p-1.5">
            <span class="sr-only">Rohim Blog</span>
            <h1 class="text-2xl text-normal"><span class="font-bold">Rohim</span> Blog</h1>
          </a>
        </div>
    ...
    <div class="relative isolate px-6 pt-14 lg:px-8">
      ...
      <div class="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
        ...
        <div class="text-center">
          <h1 class="text-4xl font-bold tracking-tight text-gray-900 sm:text-6xl">Welcome to Rohim Blog</h1>
    ...
    <div class="p-4 py-6 mx-auto max-w-screen-xl md:p-8 lg:p-10">
        <div class="text-center">
            <a href="#" class="flex justify-center items-center mb-5 text-2xl font-semibold text-gray-900 dark:text-white">
              <span class="text-2xl text-normal"><span class="font-bold">Rohim</span> Blog</span>    
            </a>
            <span class="block text-sm text-center text-gray-500 dark:text-gray-400">© 2024 <a href="#" class="hover:underline">Rohim&#8482;</a>. All Rights Reserved.
            </span>
